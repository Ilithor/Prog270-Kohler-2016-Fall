...
function elfFireConfig02() {
    var config = {
        apiKey: "AIzaSyBwgE4EG-tIRIOTPMKZsoyu0OPDEtnTEDk",
    authDomain: "prog270-data-kohler.firebaseapp.com",
    databaseURL: "https://prog270-data-kohler.firebaseio.com",
    storageBucket: "prog270-data-kohler.appspot.com",
    messagingSenderId: "387576140780"
    };
    firebase.initializeApp(config);
}
